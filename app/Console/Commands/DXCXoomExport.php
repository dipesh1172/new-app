...
class DXCXoomExport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dxc:xoom:export {--start-date=} {--end-date=}';
     ...
     * @var string
     */
    protected $description = 'Temporary command for formatting and exporting Xoom Energy TPV data for import into DXC\'s database.';
    ...
    public function handle()
    {
        if (!$this->option('start-date') || !$this->option('end-date')) {
            $this->error("Missing parameter(s). Both --start-date and --end-date are required.");
            return -2;
        }
        ...
        try {
            ...
            // Create the file
            $filename = "xoom-tpvs-export-" . time() . ".csv";
            ...
            foreach ($data as $r) {
                ...
                $record = [
                    ...
                    "form_name" => "Xoom Energy - " . $r->language,
