...
class DirectEnergyEnrollment_tpv_wr_78 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'DirectEnergy:EnrollmentFile:tpv:wr:78 {--mode=} {--noftp} {--noemail} {--start-date=} {--end-date=}';
     ...
     * @var string
     */
    protected $jobName = 'Direct Energy - Enrollment File - tpv_wr_78 ';
    ...
    protected $distroList = [
        'ftp_success' => [ // FTP success email notification distro
            'live' => ['dxc_autoemails@tpv.com','sharon.gallardo@answernet.com','_tpvteam@directenergy.com','contract.alberta@directenergy.com','curt.cadwell@answernet.com'],
...
//        'ssl' => true,
    ...
    public function handle()
    {
        ...
        $filename = ($this->mode == 'test' ? 'TEST_' : '')
            ...
            . '013000.csv';
           $testcurt = $this->startDate->year;

        // Data layout/File header for main TXT/CSV files.
        $csvHeader = $this->flipKeysAndValues([
            'Contract_ID_Number', 'TPV_Confirmation_Number', 'TPV_Date', 'TPV_Time', 'TPV_Status', 'Bonus_Status', 'program_code', 'program',
            'offer_code', 'promo_code', 'promo_key'
        ]);
