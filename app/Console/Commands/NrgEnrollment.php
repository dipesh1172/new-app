...
class NrgEnrollment extends Command
{
     ...
     * @var string
     */
    protected $signature = 'Nrg_Enrollment {--mode=} {--noftp} {--noemail} {--start-date=} {--end-date=}';
     ...
     * @var string
     */
    protected $jobName = 'NRG Enrollment - FTP File Generation ';
     ...
     * @var string
     */
    protected $description = 'Creates, FTPs, and Emails Nrg\'s enrollment file';
     ...
     * @var array
     */
    protected $brandId = '7c8552f9-a40f-4952-8fcb-46ae5b0e9b1d'; //  prod ID
    ...
    protected $distroList = [
        'ftp_success' => [ // FTP success email notification distro
            'live' => ['dxc_autoemails@tpv.com', 'engineering@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com'],
            'test' => ['dxc_autoemails@tpv.com', 'engineering@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com']
        ],
        'ftp_error' => [ // FTP failure email notification distro
            'live' => ['dxcit@tpv.com', 'engineering@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com'],
            'test' => ['dxc_autoemails@tpv.com', 'engineering@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com']

        ],
        'emailed_file' => [ // Emailed copy of the file distro
            'live' => ['dxc_autoemails@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com'],
            'test' => ['dxcit@tpv.com','curt.cadwell@answernet.com','curt@tpv.com','autumn.campbell@answernet.com']
        ]
    ];
...
//                'CONFIRMATIONID' => '',  // in DXC the is recid we only have guid will see if DE kicks back error
        ...
        // Upload the file to FTP server
         if (!$this->option('noftp')) {
            ...
            try {
                $stream = fopen(public_path($folderName . $filename), 'r+');
