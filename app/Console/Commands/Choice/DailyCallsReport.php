...
namespace App\Console\Commands\Choice;
...
class DailyCallsReport extends Command
{
     ...
     * @var string
     */
    protected $signature = 'choice:reports:daily-calls:email {--mode=} {--env=} {--no-email} {--show-sql} {--start-date=} {--end-date=}';
     ...
     * @var string
     */
    protected $description = 'Daily calls for Choice Energy LLC';
     ...
     * @var string
     */
    protected $brand = 'Choice Energy LLC';
     ...
     */
    protected $brandId = [
        'prod' => 'c4fbae2c-3f59-4b79-8f19-53e60ef0aee1',
        'stage' => 'c4fbae2c-3f59-4b79-8f19-53e60ef0aee1'
    ];
    ...
    protected $distroList = [
        'live' => ['MNeedham@4choiceenergy.com', 'robb.prohaska@pbsolutions1.com', 'brent.hood@pbsolutions1.com', 'QA@pbsolutions1.com', 'dxc_autoemails@tpv.com', 'jose.nava45821@answernet.com'],
    ...
    public function handle()
    {
        ...
        foreach ($data as $r) {
            ...
            $passedReview = '-';
            if($r->interaction_type == 'ivr_review' && $complete == 'Y') {
                $passedReview = ($r->result == 'Sale' ? 'Y' : 'N');
            }

            $electricRateType = '';
            if(strtolower($r->commodity) == 'electric') {
                $electricRateType = ($r->custom_data_1 ? $r->custom_data_1 . ' Kilowatts' : '');
            }
