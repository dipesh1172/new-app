...
/**
 * GM Retail import for retail surveys
 * 
 */
class ImportSurveysGMRetail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gm:surveysimportretail {--brand=} {--script=} {--emailto=}';
     ...
     * @var string
     */
    protected $description = 'Import GM Retail Surveys';
     ...
     public function handle()
    {
            ...
            try {
                ...
                foreach ($files as $file) {
                    if ($file['type'] === 'file' and $file['extension'] === 'txt' and substr_count(strtolower($file['filename']),'gmeretailfiledrop_') == 1)  {
                       ...
                       if ($filesystem->has( 'processed/' . $file['filename'] . '_' . $filetimestamp . '.txt')) {
                        $filesystem->delete($file['path']);
                         ...
                         $subject = 'GM - Retail QC Callbacks - Data Import '. Carbon::now('America/Chicago')->format("Ymd-His");
                       ...
                       $message = 'GM Retail Sales Data File Processed: ' . $file['path'] . ' ' . $totalrecs . ' Records were imported.';
                       $data = [
                           'subject' => '',
                           'content' => $message
                       ];
