...
class SparkRateImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SparkRateImport {--mode=} {--noemail}';
     ...
     * @var string
     */
    protected $jobName = 'Spark Rate Import ';
     ...
     * @var string
     */
    protected $description = 'Spark Rate Import process';
    ...
    protected $distroList = [
        'ftp_success' => [ // FTP success email notification distro
            'live' => ['dxc_autoemails@tpv.com', 'curt.cadwell@answernet.com','EnrollmentsandContractManagement1@sparkenergy.com'],  // EnrollmentsandContractManagement1@sparkenergy.com
        ...
        'emailed_file' => [ // Emailed copy of the file distro
            'live' => ['curt.cadwell@answernet.com','dxc_autoemails@tpv.com','EnrollmentsandContractManagement1@sparkenergy.com'],
            //'test' => ['dxcit@tpv.com']
            'test' => ['curt.cadwell@answernet.com','curt@tpv.com']
    ...
    protected $ftpSettings = [
        'live' => [
            ...
            'password' => '',
            'passive' => true,
            'root' => '/Marketing/AnswerNetTPV/From Spark/Rate Import',
            //        'passive' => true,
            //        'ssl' => true,
            'timeout' => 30,
            'directoryPerm' => 0755,
    ...
    public function handle()
    {
        ...
        if (strtolower($this->mode) == 'live')  {
            $brand_id = '7845a318-09ff-42fa-8072-9b0146b174a5';   // prod
            // $brand_id = '6ed156aa-a95d-4df6-905d-df6c56956463';  // staging
        ...
        try {
            $fileNameToCheckFor = 'FocusRateChanges_';
