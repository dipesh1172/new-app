...
class RushmoreSymmetryEnrollmentFile extends Command
{
     ...
     * @var string
     */
    //protected $signature = 'RushmoreSymmetryEnrollmentFile {--mode=} {--start-date=} {--end-date=} {--noftp} {--noemail}';
    protected $signature = 'RushmoreSymmetryEnrollmentFile {--mode=} {--start-date=} {--end-date=} {--noemail}';
     ...
     * @var string
     */
    protected $jobName = 'Rushmore/Symmetry Enrollment File ';
     ...
     * @var array
     */
    protected $brandId = '86685b8a-b1b2-45a9-a84e-2db37fe6f5d7'; //  prod ID
    ...
    protected $distroList = [  // Left FTP logic in case client changes mind
        ...
        'emailed_file' => [ // Emailed copy of the file distro
            'live' => ['dxc_autoemails@tpv.com','accountmanagers@answernet.com','curt.cadwell@answernet.com','operations@rushmoreenergy.com','enrollments@rpm-mail.symmetryenergy.com','lauren@tpv.com','christopher.jerez@answernet.com'],
            'test' => ['curt.cadwell@answernet.com']
            //'test' => ['curt.cadwell@answernet.com']
    ...
    public function handle()
    {
        ...
        $filename = ($this->mode == 'test' ? 'TEST_' : '')
             ...
             . 'rushmore_symmetry_energy_enrollment.csv';
        ...
        if(count($data) === 0) {
            ...
            $message = 'There were no records to send for Rushmore/Symmetry Enrollment File ' . $this->startDate->format('m-d-Y') . '.';
        ...
        foreach ($data as $r) {
            ...
            $row = [
                ...
                'LDC Meter Number' => $r->account_number2,
                'POOL NUMBER' => '',
        ...
        if (!$this->option('noemail')) {
            ...
            $this->sendEmail('Attached is the file for Rushmore/Symmetry Enrollment file' . $this->startDate->format('m-d-Y') . '.', $this->distroList['emailed_file'][$this->mode], $attachments);
        }
