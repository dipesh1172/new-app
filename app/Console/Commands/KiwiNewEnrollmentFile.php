...
class KiwiNewEnrollmentFile extends Command
{
     ...
     * @var string
     */
    protected $signature = 'KiwiNewEnrollmentFile {--mode=} {--start-date=} {--end-date=} {--noftp} {--noemail}';
     ...
     * @var string
     */
    protected $jobName = 'Kiwi New Enrollment File ';
    ...
    public function handle()
    {
        ...
        if(count($data) === 0) {
            ...
            $message = 'There were no records to send for Kiwi New Enrollment File' . $this->startDate->format('m-d-Y') . '.';
        ...
        foreach ($data as $r) {
           ...
           if($r->custom_fields) {
            ...
            $row = [
                ...
                'LOA' => '',
                'UtilityName' => $r->utility_commodity_external_id,
