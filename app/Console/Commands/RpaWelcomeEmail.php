...
class RpaWelcomeEmail extends Command
{
     ...
     * @var string
     */
    protected $signature = 'rpa:welcome:email {--debug} {--file=} {--single} {--dryrun}';
                                    ...
                                    case 'text':
                                        if (isset($data['btn'])) {
                                            if ($event->language_id == 2) {
                                                $message = config('app.urls.clients') . '/rpa/welcome/' . $event->id
