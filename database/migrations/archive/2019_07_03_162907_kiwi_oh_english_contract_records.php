...
class KiwiOhEnglishContractRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $commodities = [
            'electric' => [
                'contract_pdf' => 'kiwi_oh_dtd_residential_electric_english_20190703.pdf',
                'number_of_pages' => 13,
                'signature_info_customer' => '{"9":{"0":"355,523,180,44"}}'
            ],
            'gas' => [
                'contract_pdf' => 'kiwi_oh_dtd_residential_gas_english_20190703.pdf',
                'number_of_pages' => 13,
                'signature_info_customer' => '{"9":{"0":"355,523,180,44"}}'
            ],
            'dual' => [
                'contract_pdf' => 'kiwi_oh_dtd_residential_dual_english_20190703.pdf',
                'number_of_pages' => 15,
                'signature_info_customer' => '{"10":{"0":"355,523,180,44"}}'
            ]
        ];
