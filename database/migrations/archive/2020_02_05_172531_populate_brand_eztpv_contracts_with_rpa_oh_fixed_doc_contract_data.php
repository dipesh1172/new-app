...
class PopulateBrandEztpvContractsWithRpaOhFixedDocContractData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            foreach ($commodities as $commodity) {
                ...
                $bec->contract_pdf = 'rpa_oh_res_dtd_dual_fixed_english_custom_20200205.docx';
