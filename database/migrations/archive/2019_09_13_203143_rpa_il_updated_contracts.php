...
class RpaIlUpdatedContracts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $contracts = [
            'rpa_il_dtd_residential_dual_2019_05_28.pdf' => [
                'contract_pdf' => 'rpa_il_res_dtd_dual_english_custom_20190913.pdf',
                'signature_info_customer' => '{"1":{"0":"36,864,190,35"}}',
                'signature_info_agent' => '{"1":{"0":"37,917,190,35"}}',
                'number_of_pages' => 4,
                'page_size' => 'Legal'
            ],
            'rpa_il_dtd_residential_spanish_dual_contract_20190702' => [
