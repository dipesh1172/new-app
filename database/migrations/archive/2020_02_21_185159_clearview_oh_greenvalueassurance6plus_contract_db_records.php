...
class ClearviewOhGreenvalueassurance6plusContractDbRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            ...
            $bec->contract_pdf = 'clearview_oh_GreenValueAssurance6Plus_sigpage_20200221.docx';
