...
class KiwiOhContractSignaturePositioningRedux extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $data = [
            'kiwi_oh_dtd_residential_gas_spanish_20190703.pdf' => [
                'signature_info_customer' => '{"10":{"0":"332,377,180,44"}}'
            ],
            'kiwi_oh_dtd_residential_gas_english_20190703.pdf' => [
                'signature_info_customer' => '{"9":{"0":"353,538,180,44"}}'
            ],
            'kiwi_oh_dtd_residential_electric_spanish_20190703.pdf' => [
                'signature_info_customer' => '{"10":{"0":"332,378,180,44"}}'
            ],
            'kiwi_oh_dtd_residential_electric_english_20190703.pdf' => [
                'signature_info_customer' => '{"9":{"0":"353,537,180,44"}}'
            ],
            'kiwi_oh_dtd_residential_dual_spanish_20190703.pdf' => [
                'signature_info_customer' => '{"11":{"0":"332,378,180,44"}}'
            ],
            'kiwi_oh_dtd_residential_dual_english_20190703.pdf' => [
                'signature_info_customer' => '{"10":{"0":"353,538,180,44"}}'
            ]
        ];
