...
class CorrectFieldsOnDynegyIlContract extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $bec = BrandEztpvContract::where('contract_pdf', 'Dynegy_IL_Electric_with_UDS_2019-02-20.pdf')->first();
        $bec->contract_pdf = 'Dynegy_IL_Electric_with_UDS_2019-02-22.pdf';
