...
class RpaNjContracts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($commodities as $commodity) {
            ...
            $bec->contract_pdf = 'rpa_nj_dtd_residential_dual_2019_05_28.pdf';
            $bec->contract_fdf = $this->rpa_nj_fdf();
            $bec->page_size = 'Letter';
            $bec->number_of_pages = 2;
            $bec->signature_required = 1;
            $bec->signature_info = '{"1":{"0":"36,619,144,21"}}';
            $bec->state_id = 31;
            $bec->channel_id = 1;
