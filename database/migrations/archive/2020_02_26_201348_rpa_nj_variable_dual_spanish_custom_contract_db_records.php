...
class RpaNjVariableDualSpanishCustomContractDbRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            foreach ($commodities as $commodity) {
                ...
                $bec->contract_pdf = 'rpa_nj_allMarket_allChannel_dual_variable_spanish_custom_20200226.docx';
