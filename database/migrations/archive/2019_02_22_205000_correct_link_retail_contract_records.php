...
class CorrectLinkRetailContractRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $bec = BrandEztpvContract::where('contract_pdf', 'Link_Retail_dual_2019_02_05.pdf')->get();
        foreach ($bec as $row)
        {
            $row->contract_fdf = $this->new_fdf();
            $row->save();
        }
