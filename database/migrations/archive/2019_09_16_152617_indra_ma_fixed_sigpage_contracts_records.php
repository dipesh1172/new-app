...
class IndraMaFixedSigpageContractsRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $contracts = [
            'indra_ma_res_dtd_electric_english_fixed_sigpage_20190916.pdf' => [
                'number_of_pages' => 6,
                'language_id' => 1
            ],
            'indra_ma_res_dtd_electric_spanish_fixed_sigpage_20190916.pdf' => [
                'number_of_pages' => 7,
                'language_id' => 2
            ]
        ];
