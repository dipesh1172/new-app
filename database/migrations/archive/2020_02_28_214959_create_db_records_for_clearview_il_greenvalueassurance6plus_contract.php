...
class CreateDbRecordsForClearviewIlGreenvalueassurance6plusContract extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            ...
            $bec->contract_pdf = 'clearview_il_GreenValueAssurance6Plus_sigpage_20200225.docx';
            ...
            $bec->file_name = 'clearview_il_GreenValueAssurance6Plus_sigpage_20200225.docx';
            $bec->save();
        }
