...
class RpaOhContractRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($commodities as $commodity) {
            ...
            $bec->contract_pdf = 'rpa_oh_dtd_residential_dual_2019_05_29.pdf';
            $bec->contract_fdf = $this->rpa_oh_fdf();
            $bec->page_size = 'Legal';
            $bec->number_of_pages = 2;
            $bec->signature_required = 1;
            $bec->signature_info = '{"1":{"0":"20,128,144,21"}}';
            $bec->state_id = 36;
            $bec->channel_id = 1;
