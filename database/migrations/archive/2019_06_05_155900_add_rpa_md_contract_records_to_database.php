...
class AddRpaMdContractRecordsToDatabase extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($commodities as $commodity) {
            ...
            $bec->contract_pdf = 'rpa_md_dtd_residential_dual_2019_06_05.pdf';
            $bec->contract_fdf = $this->rpa_md_fdf();
            $bec->page_size = 'Legal';
            $bec->number_of_pages = 2;
            $bec->signature_required = 1;
            $bec->signature_info = '{"1":{"0":"82,790,141,22"}}';
            $bec->signature_required_customer = 1;
            $bec->signature_info_customer = '{"1":{"0":"82,790,141,22"}}';
            $bec->signature_required_agent = 1;
            $bec->signature_info_agent = '{"1":{"0":"82,836,141,22"}}';
            $bec->state_id = 21;
            $bec->channel_id = 1;
