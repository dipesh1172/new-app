...
class UpdateIndraPaTieredContracts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $contracts = [
            'resources/assets/documents/indra_pa_tiered_dual_english_20190905.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_dual_english_20191001.pdf',
                'contract_fdf' => $this->dual_fdf()
            ],
            'resources/assets/documents/indra_pa_tiered_dual_spanish_20190905.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_dual_spanish_20191001.pdf',
                'contract_fdf' => $this->dual_fdf()
            ],
            'resources/assets/documents/indra_pa_tiered_electric_english_20190611.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_electric_english_20191001.pdf',
                'contract_fdf' => $this->electric_fdf()
            ],
            'resources/assets/documents/indra_pa_tiered_electric_spanish_20190612.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_electric_spanish_20191001.pdf',
                'contract_fdf' => $this->electric_fdf()
            ],
            'resources/assets/documents/indra_pa_tiered_gas_english_20190905.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_gas_english_20191001.pdf',
                'contract_fdf' => $this->gas_fdf()
            ],
            'resources/assets/documents/indra_pa_tiered_gas_spanish_20190905.pdf' => [
                'contract_pdf' => 'resources/assets/documents/indra_pa_tiered_gas_spanish_20191001.pdf',
                'contract_fdf' => $this->gas_fdf()
            ]
        ];
