...
class ClearviewOhGreenvalueassuranceplusContractDbRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            ...
            $bec->contract_pdf = 'clearview_oh_GreenValueAssurancePlus_sigpage_20200221.docx';
