...
class PopulateBrandEztpvContractsTableForRpaPaVariableEnglishContract extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($channels as $channel) {
            foreach ($commodities as $commodity) {
                ...
                $bec->contract_pdf = 'rpa_pa_res_dtd_dual_variable_english_custom_20200210.docx';
