...
class RpaPaContractRecords extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        foreach ($commodities as $commodity) {
            ...
            $bec->contract_pdf = 'rpa_pa_dtd_residential_dual_2019_05_31.pdf';
            $bec->contract_fdf = $this->rpa_pa_fdf();
            $bec->page_size = 'Legal';
            $bec->number_of_pages = 4;
            $bec->signature_required = 1;
            $bec->signature_info = '{"1":{"0":"36,816,144,21"}}';
            $bec->state_id = 39;
            $bec->channel_id = 1;
