...
class AddIndexesToBrandsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('brands', function (Blueprint $table) {
            ...
            $indexesFound = $sm->listTableIndexes('brands');
            ...
            if (!array_key_exists('idx_client_id',  $indexesFound)) { $table->index('client_id',  'idx_client_id');  }
        });
    }
    ...
    public function down()
    {
        Schema::table('brands', function (Blueprint $table) {
            ...
            if (array_key_exists('idx_client_id',  $indexesFound)) { $table->dropIndex('idx_client_id');  }
        });
    }
}
