		...
		<div class="animated fadeIn">
			<div class="card">
				<div class="card-header">
					<i class="fa fa-th-large"></i> Edit Document
				</div>
				<div class="card-body">
					...
					{{ Form::open(array('route' => array('documents.update', $doc->id), 'method' => 'put', 'autocomplete' => 'off')) }}
                    	<div class="row">
                    		<div class="col-md-11">
								<div class="form-group">
									<label for="inputTitle1">Title</label>
									<input type="text" class="form-control form-control-lg" name="title" id="inputTitle1" placeholder="Enter a Title" value="{{ $doc->title }}">
								</div>
							</div>
							<div class="cold-md-1">
								<label for="inputStatus1">Status</label>
								<select name="status" class="form-control form-control-lg">
									<option value="1" {{ $doc->status == 1 ? "selected" : "" }}>Enabled</option>
									<option value="0" {{ $doc->status == 0 ? "selected" : "" }}>Disabled</option>
								</select>
							</div>
						</div>
                        <div class="form-group">
                        	<div class="row">
                        		<div class="col-md-9">
		                            <textarea name="doc">{{ $doc->document }}</textarea>
		                        </div>
		                        <div class="col-md-3">
									<div class="card">
										<div class="card-header">
