...
@section('content')
    @breadcrumbs([
        ...
        ['name' => 'Sales Agents Dashboard', 'url' => '/sales_dashboard/agents', 'active' => true],
        ['name' => 'TPV Agents Dashboard', 'url' => '/sales_dashboard/tpv_agents', 'active' => false],
    ])

    <div class="container-fluid">
        <div class="animated fadeIn">
            <div id="sales-agent-dashboard">
