                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="content-block aligncenter">
                            <a href="{{ config('app.urls.mgmt') }}/invoice/{{ $id }}/download?url={{ config('services.aws.cloudfront.domain').'/'.$url['filename'] }}" class="btn-primary">Click here to download {{ $url['doc'] }}</a>
                        </td>
                    </tr>
                    @endforeach
