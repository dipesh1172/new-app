...
<table width="100%" cellpadding="0" cellspacing="0" class="main content-wrap">
    ...
    <tr>
        ...
        <td class="content-block">
            ...
            Le informamos de que el plazo de vigencia de la tarifa fija de su suministro de electricidad expirará el {{ $rateExpirationDate }}. Elija hoy mismo una de nuestras tarifas fijas para Clientes Preferentes llamándonos al <a href="tel:18006850960">1-800-685-0960</a>. Seleccione un nuevo plan de tarifa fija con nosotros antes de {{ $respondByDate }}, para que entre en vigor inmediatamente después del vencimiento de su tarifa fija actual. Tu contrato actual no tiene comisión de cancelación.<br /><br />

            Al menos 30 días antes del vencimiento de su actual tarifa fija, le enviaremos otra carta recordándole sus opciones. Si decide no hacer nada y dejar que venza su actual tipo fijo, su cuenta continuará automáticamente con un tipo variable mes a mes, que podrá cambiar en cualquier momento sin penalización ni comisión por cancelación anticipada.<br /><br />
        ...
        <td class="content-block">
            ...
            We would like to inform you that the fixed rate term for your electricity supply will expire on {{ $rateExpirationDate }}. Choose one of our Preferred Customer fixed rates today by calling us at <a href="tel:18006850960">1-800-685-0960</a>. Select a new fixed rate plan with us before {{ $respondByDate }} to ensure that it goes into effect immediately upon the expiration of your current fixed rate. Your current contract has no cancellation fee.<br /><br />

            At least 30 days prior to the expiration of your existing fixed rate term, we will send you another letter reminding you of your options. If you decide to take no action and let your current fixed rate expire, your account will automatically continue on a month-to-month variable rate, which you can change at any time without penalty or early termination fee.<br /><br />
