...
<table width="100%" cellpadding="0" cellspacing="0" class="main content-wrap">
    ...
    <tr>
        ...
        <td class="content-block">
            ...
            Nos gustaría informarle que el plazo de tarifa fija para su suministro eléctrico vencerá el {{ $rateExpirationDate }}.<br /><br />

            Elija una de nuestras tarifas fijas para Clientes Preferidos hoy llamándonos al <a href="tel:18006850960">1-800-685-0960</a>. Seleccione un plan nuevo de tarifa fija con nosotros antes de {{ $respondByDate }} para asegurarse de que entre en vigencia inmediatamente después de que expire su tarifa fija actual.<br /><br />

            Si decide no tomar ninguna medida, al final del plazo actual este acuerdo se renovará automáticamente mes a mes con los mismos términos y precios que su acuerdo actual.<br /><br />

            ¡Realmente apreciamos su negocio y esperamos continuar sirviendo sus necesidades energéticas!<br /><br />
        ...
        <td class="content-block">
            ...
            We would like to inform you that the fixed rate term for your electric supply will expire on {{ $rateExpirationDate }}.<br /><br />
            ...
            If you decide to take no action, at the end of the current term this agreement will automatically renew on a month-to-month basis on the same terms and pricing as your current agreement.<br /><br />
