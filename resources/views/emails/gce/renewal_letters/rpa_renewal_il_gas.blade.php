...
<table width="100%" cellpadding="0" cellspacing="0" class="main content-wrap">
    ...
    <tr>
        ...
        <td class="content-block">
            ...
            Gracias por elegir a Green Choice Energy como su proveedor de gas natural.<br /><br />
            ...
            <table>
                <tr>
                    <td>Tarifa Actual: {{ $rateAmount }} centavos/therm</td>
                    <td>Nueva tarifa: {{ $renewalRate }} centavos/therm</td>
                </tr>
            </table>
        ...
        <td class="content-block">
            ...
            Thank you for choosing Green Choice Energy as your natural gas supplier.<br /><br />
            ...
            <table>
                <tr>
                    <td>Current rate: {{ $rateAmount }} cents/therm</td>
                    <td>Renewal rate: {{ $renewalRate }} cents/therm</td>
                </tr>
            </table>
