...
<table width="100%" cellpadding="0" cellspacing="0" class="main content-wrap">
    ...
    <tr>
        ...
        <td class="content-block">
            ...
            Si decide no tomar ninguna medida y deja que su tasa fija actual caduque, su cuenta continuará automáticamente con una tasa variable de mes a mes. Puede cambiar o cancelar su plan en cualquier momento sin penalización comunicándose con nosotros al <a href="tel:18006850960">1-800-685-0960</a>. Nuestra tasa variable mensual puede cambiar cada mes según nuestra evaluación de los costos históricos y proyectados asociados con el servicio de su cuenta, incluidos los costos actuales y estimados de Green Choice para obtener suministro eléctrico al por mayor, ajustes de períodos anteriores costos de inventario y balance, costos de transporte y transmisión incurridos por Green Choice, y otros factores relacionados con el mercado y el negocio, tales como costos administrativos, gastos y márgenes. La tarifa variable puede ser más alta o más baja que cualquier precio ofrecido anteriormente en este contrato o la tarifa actual de su servicio público, no hay límite ni límite en la tarifa variable de un ciclo de facturación al siguiente y no garantizamos ahorros. Puede revisar nuestras tarifas variables actuales y futuras visitando <a href="www.GreenChoiceEnergy.com">www.GreenChoiceEnergy.com</a> y refiriéndose a la sección específica de Delaware ubicada en la parte inferior de la página. Se adjuntan los términos y condiciones para el servicio de suministro de tarifa variable de mes a mes.<br /><br />

            Si desea terminar su servicio con nosotros sin penalización y no seguir siendo un cliente de Green Choice Energy, puede hacerlo llamando al número anterior, enviándonos un correo electrónico a info@greenchoiceenergy.com o enviando una solicitud por escrito a Green Choice Energy, 14 Wall St 2nd Fl Huntington, NY 11743. Si rescinde su contrato de suministro sin seleccionar otro proveedor, volverá al servicio básico de su empresa.<br /><br />
        ...
        <td class="content-block">
            ...
            If you decide to take no action and let your current fixed rate expire, your account will automatically continue on a month-to-month variable rate. You can change or terminate your plan at any time without penalty by contacting us at <a href="tel:18006850960">1-800-685-0960</a>. Our monthly variable rate may change each month based on our assessment of historic and projected costs associated with serving your account including Green Choice’s actual and estimated costs of obtaining wholesale electricity supply, prior period adjustments, inventory and balancing costs, transportation and transmission costs incurred by Green Choice, and other market and business related factors such as administrative costs, expenses, and margins. The variable rate may be higher or lower than any price offered previously on this contract or your utility’s current rate, there is no cap or limit on the variable rate from one billing cycle to the next, and we do not guarantee savings. You can review our current and upcoming variable rates by visiting <a href="www.GreenChoiceEnergy.com">www.GreenChoiceEnergy.com</a> and referring to the Delaware-specific section located at the bottom of the page. The terms and conditions for the month-to-month variable rate supply service are enclosed.<br /><br />
