    ...
    $.extend({
        ...
        function () {
            ...
            function buildHeaders(table) {
                ...
                const header_index = computeTableHeaderCellIndexes(table);
                ...
                $tableHeaders = $(table.config.selectorHeaders, table).each(function (index) {
                    ...
                    if (!this.sortDisabled) {
                        const $th = $(this).addClass(table.config.cssHeader);
            ...
            function computeTableHeaderCellIndexes(t) {
                const matrix = [];
                const lookup = {};
                const thead = t.getElementsByTagName('THEAD')[0];
                ...
                for (let i = 0; i < trs.length; i++) {
                    ...
                    for (let j = 0; j < cells.length; j++) {
                        ...
                        const rowIndex = c.parentNode.rowIndex;
                        const cellId = `${rowIndex}-${c.cellIndex}`;
            ...
            function multisort(table, sortList, cache) {
                ...
                for (var i = 0; i < l; i++) {
                    ...
                    const s = (table.config.parsers[c].type == 'text') ? ((order == 0) ? makeSortFunction('text', 'asc', c) : makeSortFunction('text', 'desc', c)) : ((order == 0) ? makeSortFunction('numeric', 'asc', c) : makeSortFunction('numeric', 'desc', c));
                    const e = `e${i}`;
            ...
            this.construct = function (settings) {
                return this.each(function () {
                    ...
                    $this.bind('update', function () {
                        ...
                        const pos = [(cell.parentNode.rowIndex - 1), cell.cellIndex];
                        // update cache
