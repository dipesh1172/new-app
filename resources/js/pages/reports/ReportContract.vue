...
export default {
    ...
    data() {
        return {
            ...
            return [
            {...commonHeaderforcontact,label: 'Brand',align: 'left',key: 'name',serviceKey: 'name',sorted: ASC_SORTED,},
            {...commonHeaderforcontact,label: 'Vendor',align: 'left',key: 'vendor_name',serviceKey: 'vendor_name',sorted: ASC_SORTED,},
            {...commonHeaderforcontact,label: 'Created At',key: 'created_at',serviceKey: 'created_at',width: '30%',type: 'date',},
            {...commonHeaderforcontact,label: 'Channel',key: 'channel',serviceKey: 'channel',},
            {...commonHeaderforcontact,label: 'State',key: 'state_abbrev',serviceKey: 'state_abbrev',},
            {...commonHeaderforcontact,label: 'Language',key: 'language',serviceKey: 'language',},
            {...commonHeaderforcontact,label: 'Confirmation Code',key: 'confirmation_code',serviceKey: 'confirmation_code',canSort: false,},
            ];
            })(),
            dataIsLoaded: false,
